...
def general_weighted_average(e):
    ...
    subjects = ['Science', 'Math', 'English', 'Filipino', 'ICT', 'PE', 'AP', 'Values']
    ...
    weighted_sum = (
        ...
        pe * units_subject[3] +
        ap * units_subject[3] +
        values * units_subject[3]
    )

    total_units = (units_subject[0] * 3) + units_subject[1] + units_subject[2] + (units_subject[3] * 3)
